// search랑 input 찾아서 search -> searchEl, input -> searchInputEl
// searchEl 아무데나 눌러도 searchInputEl이 포커스되도록 만들기
// searchInputEl이 포커스됐을 때 '통합검색' 나오게 만들기
// searchInputEl이 blur됐을 때 '' 빈값 처리
...
// lodash로 0.3초마다 함수를 실행할수 있도록 처리
// _.throttle(함수, 시간)
